    ...
    return (
        ...
        <div className="flex justify-center pt-24  ">
            <div className="grid grid-rows-2 md:grid-rows-none md:grid-cols-2  w-[80rem] gap-6 md:gap-0   h-auto ">
                <div className=" row-span-2   md:col-span-1   flex  items-center pl-5 sm:pl-10 h-full ">
                ...
                <div className="row-span-1 md:col-span-1 pl-5 sm:pl-10 pr-5 md:pl-0 lg:pr-10  flex justify-center items-center md:none  ">
