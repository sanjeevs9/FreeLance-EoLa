...
export default function ContactUs(){
    return(
        ...
        <div className="flex  justify-center p-5  ">
            <div className="flex flex-col lg:flex-row  w-[72rem]   pl-10 pr-10 gap-40">
                <div className=" justify-center flex">
                    <Map/>
                </div>
                <div className="flex flex-col  w-full gap-10">
                    <div>
                    <div className="font-cormorant-gara italic text-[#f5989d] text-xl" >Elegant Shop</div>
                    <div className="font-cormorant-uni text-4xl font-medium">Contact Us</div>
                    </div>
