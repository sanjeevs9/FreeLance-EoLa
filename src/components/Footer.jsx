               ...
               <div className="flex flex-col lg:flex-row  justify-between items-center w-[70rem] lg:pl-10 lg:pr-10  "> 
                    ...
                    <div>
                        ...
                        <div className="flex flex-col  lg:flex-row font-work-sans xl:gap-16 lg:gap-14 gap-4 text-xs text-center pt-8 lg:pt-0 pb-8 lg:pb-0  items-center" >
                            ...
                            <div className="  cursor-pointer relative text-black   transition-all before:transition-[width] ontransition-all before:duration-300 before:absolute before:bg-[#f5989d] before:origin-center before:h-[1px] before:w-0 hover:before:w-[50%] before:bottom-0 before:left-[50%] after:transition-[width] ontransition-all after:duration-300 after:absolute after:bg-[#f5989d] after:origin-center after:h-[1px] after:w-0 hover:after:w-[50%] after:bottom-0 after:right-[50%] hover:text-[#f5989d]">CONTACT US</div>
